...
import com.brayancordeiro.restwithspringboot.services.BookServices;
...
public class BookController {
	...
	@Operation(summary = "Find all registered books", description = "Find all registered books",
		tags = {"Books"},
		responses = {
	...
	description = "Adds a new Book by passing in a JSON, XML or YAML representation",
	tags = {"Book"},
	responses = {
		@ApiResponse(description = "Success", responseCode = "200", 
			content = @Content(schema = @Schema(implementation = PersonVO.class))
	...
	@PutMapping(
			consumes = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML},
			produces = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML})
	@Operation(summary = "Updates a Book from database", 
	description = "Updates a book by passing in a JSON, XML or YAML representation",
	tags = {"Book"},
	responses = {
	...
	@Operation(summary = "Deletes a Book from database", 
	description = "Deletes a Book by passing in a JSON, XML or YAML representation",
	tags = {"Book"},
	responses = {
		@ApiResponse(description = "No Content", responseCode = "204", content = @Content),
		@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
